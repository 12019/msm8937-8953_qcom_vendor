...
typedef struct mdtp_v1_command
{
  int type;
  union   {
...
DECLARE_ASN1_FUNCTIONS(MDTP_V1_COMMAND)

typedef struct mdtp_v1_message
{
  ASN1_OCTET_STRING *idToken;
  ASN1_ENUMERATED *messageType;
  MDTP_V1_COMMAND *mdtpV1command;
} MDTP_V1_MESSAGE;

DECLARE_ASN1_FUNCTIONS(MDTP_V1_MESSAGE)
