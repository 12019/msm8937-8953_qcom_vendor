...
LOC_BOARD_PLATFORM_LIST += msmcobalt
LOC_BOARD_PLATFORM_LIST += msmfalcon
...
else ifeq ($(TARGET_BOARD_PLATFORM),msmcobalt) # MSMCOBALT specific defines
else ifeq ($(TARGET_BOARD_PLATFORM),msmfalcon) # MSMFALCON specific defines
endif
