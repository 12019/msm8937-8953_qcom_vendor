...
private:
    const GpsInterface          *m_gps_interface;
public:
    garden_state_initialized(const GpsInterface * a_gps_interface);
...
private:
    const GpsInterface          *m_gps_interface;
public:
    garden_state_session_off(const GpsInterface * a_gps_interface);
...
private:
    const GpsInterface          *m_gps_interface;
public:
    garden_state_session_on(const GpsInterface * a_gps_interface);
...
private:
    const GpsInterface          *m_gps_interface;
public:
    garden_state_gps_off(const GpsInterface * a_gps_interface);
...
public:
    garden_app_session_tracker(const GpsInterface *a_gps_interface);
