...
garden_state_initialized::garden_state_initialized(const GpsInterface * a_gps_interface): garden_state_base(),
...
garden_state_session_off:: garden_state_session_off(const GpsInterface * a_gps_interface): garden_state_base(),
                            m_gps_interface(a_gps_interface)
{
}
...
garden_state_session_on::garden_state_session_on(const GpsInterface * a_gps_interface): garden_state_base(),
                            m_gps_interface(a_gps_interface)
{
}
...
bool  garden_state_session_on::state_action()
{
    ...
    m_gps_interface->set_position_mode (GPS_POSITION_MODE_MS_BASED,
...
garden_state_gps_off::garden_state_gps_off(const GpsInterface * a_gps_interface): garden_state_base(),
                        m_gps_interface(a_gps_interface)
{
}
...
garden_app_session_tracker::garden_app_session_tracker(const GpsInterface * a_gps_interface):
