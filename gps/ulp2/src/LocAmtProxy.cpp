...
SIDE EFFECTS
   N/A
===========================================================================*/
bool LocAmtProxy::reportDeleteAidingData(GpsAidingData aidingData)
...
bool LocAmtProxy::sendGnssPositionToDr(UlpLocation &location,
                                       ...
                                       LocPosTechMask loc_technology_mask)
{
    //Send Gnss Position to external DR for consumption.
...
SIDE EFFECTS
   N/A
===========================================================================*/
bool LocAmtProxy::sendDeleteAidingDataToDr(const GpsAidingData aidingData)
{
    //Send Gnss Position to external DR for consumption.
...
SIDE EFFECTS
   N/A
===========================================================================*/
bool LocAmtProxy::reportSv(GnssSvStatus &svStatus,
                           GpsLocationExtended &locationExtended,
                           void* svExt)
{
    return  LocUlpProxy::reportSv(svStatus, locationExtended, svExt);
}
...
SIDE EFFECTS
   N/A
===========================================================================*/
bool LocAmtProxy::reportStatus(GpsStatusValue status)
{
