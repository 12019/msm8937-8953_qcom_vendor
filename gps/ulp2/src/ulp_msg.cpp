...
static int ulp_msg_process_dr_delete_aiding_data (const GpsAidingData aidingData);
                                          ...
                                          const void* locationExt)
{
   ...
   do
   {
      ...
      locationCpy.gpsLocation.size = sizeof (GpsLocation);
...
===========================================================================*/
int ulp_msg_process_dr_delete_aiding_data (const GpsAidingData aidingData)
{
   int ret_val = -1;
