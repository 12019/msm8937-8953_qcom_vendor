...
void activity_trigger_pause(const char *);
void activity_trigger_stop(const char *);
void activity_trigger_animationScalesCheck(const char *, int);
...
void activity_trigger_pause(const char *name) {
    //do nothing
}

void activity_trigger_stop(const char *name) {
    //do nothing
}
...
void activity_trigger_animationScalesCheck(const char *name, int scaleType)
{
    //do nothing
}
