...
//            {"r4oft", required_argument, 0, PARAM_RECONFIG4_OUT_FILE_TYPE},
        ...
        switch (c)
        {
            ...
            case PARAM_IN_FILE_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    buf_param->eInputFileType = u32Param;
                }
            ...
            case PARAM_OUT_FILE_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    buf_param->eOutputFileType = u32Param;
                    for(i = 0; i < MAX_RECONFIG_STREAMS; i++)
                    {
                        pFuncTestCtx->reconfig_streams[i].reconfig_pool_params.eOutputFileType = u32Param;
                    }
                }
            ...
            case PARAM_RECONFIG0_IN_FILE_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[0].reconfig_pool_params.eInputFileType = u32Param;
                }
...
*/
            case PARAM_RECONFIG1_IN_FILE_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[1].reconfig_pool_params.eInputFileType = u32Param;
                }
...
*/
            case PARAM_RECONFIG2_IN_FILE_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[2].reconfig_pool_params.eInputFileType = u32Param;
                }
...
*/
            case PARAM_RECONFIG3_IN_FILE_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[3].reconfig_pool_params.eInputFileType = u32Param;
                }
...
*/
            case PARAM_RECONFIG4_IN_FILE_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[4].reconfig_pool_params.eInputFileType = u32Param;
                }
...
*/
            case PARAM_IN_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    buf_param->eInputFileFormat = u32Param;
                }
            ...
            case PARAM_OUT_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    buf_param->eOutputFileFormat = u32Param;
                }
            ...
            case PARAM_RECONFIG0_IN_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[0].reconfig_pool_params.eInputFileFormat = u32Param;
                }
            ...
            case PARAM_RECONFIG0_OUT_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[0].reconfig_pool_params.eOutputFileFormat = u32Param;
                }
            ...
            case PARAM_RECONFIG1_IN_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[1].reconfig_pool_params.eInputFileFormat = u32Param;
                }
            ...
            case PARAM_RECONFIG1_OUT_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[1].reconfig_pool_params.eOutputFileFormat = u32Param;
                }
            ...
            case PARAM_RECONFIG2_IN_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[2].reconfig_pool_params.eInputFileFormat = u32Param;
                }
            ...
            case PARAM_RECONFIG2_OUT_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[2].reconfig_pool_params.eOutputFileFormat = u32Param;
                }
            ...
            case PARAM_RECONFIG3_IN_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[3].reconfig_pool_params.eInputFileFormat = u32Param;
                }
            ...
            case PARAM_RECONFIG3_OUT_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[3].reconfig_pool_params.eOutputFileFormat = u32Param;
                }
            ...
            case PARAM_RECONFIG4_IN_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[4].reconfig_pool_params.eInputFileFormat = u32Param;
                }
            ...
            case PARAM_RECONFIG4_OUT_PIX_FMT:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[4].reconfig_pool_params.eOutputFileFormat = u32Param;
                }
            ...
            case PARAM_IN_BUF_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    buf_param->eBufferType= u32Param;
                }
            ...
            case PARAM_RECONFIG0_IN_BUF_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[0].reconfig_pool_params.eBufferType = u32Param;
                }
            ...
            case PARAM_RECONFIG1_IN_BUF_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[1].reconfig_pool_params.eBufferType = u32Param;
                }
            ...
            case PARAM_RECONFIG2_IN_BUF_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[2].reconfig_pool_params.eBufferType = u32Param;
                }
            ...
            case PARAM_RECONFIG3_IN_BUF_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[3].reconfig_pool_params.eBufferType = u32Param;
                }
            ...
            case PARAM_RECONFIG4_IN_BUF_TYPE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->reconfig_streams[4].reconfig_pool_params.eBufferType = u32Param;
                }
            ...
            case PARAM_CADE_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pCtx->hqvCtrl.cade.mode = u32Param;
            ...
            case PARAM_AIE_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pCtx->hqvCtrl.aie.mode = u32Param;
            ...
            case PARAM_AIE_HUE_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pCtx->hqvCtrl.aie.hue_mode = u32Param;
                    pCtx->u32hqvCtrlSetFlag |= (1 << HQV_CONTROL_AIE);
                }
            ...
            case PARAM_TNR_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pCtx->hqvCtrl.tnr.mode = u32Param;
            ...
            case PARAM_CNR_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pCtx->hqvCtrl.cnr.mode = u32Param;
            ...
            case PARAM_FRC_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pCtx->hqvCtrl.frc.mode = u32Param;
            ...
            case PARAM_GLOBAL_SPLITSCREEN_DIRECTION:
                ...
                if(u32Ret == VPP_OK)
                {
                    pCtx->hqvCtrl.demo.process_direction = u32Param;
                    pCtx->u32hqvCtrlSetFlag |= (1 << HQV_CONTROL_GLOBAL_DEMO);
                }
            ...
            case PARAM_RECONFIG_HQV_MODE:
                u32Ret |= u32ConvertParams(optarg, &u32Param);
                if(u32Ret == VPP_OK)
                    pFuncTestCtx->hqvCtrl.mode = u32Param;
            ...
            case PARAM_RECONFIG_CADE_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->hqvCtrl.cade.mode = u32Param;
            ...
            case PARAM_RECONFIG_AIE_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->hqvCtrl.aie.mode = u32Param;
            ...
            case PARAM_RECONFIG_AIE_HUE_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->hqvCtrl.aie.hue_mode = u32Param;
                    pFuncTestCtx->u32hqvCtrlSetFlag |= (1 << HQV_CONTROL_AIE);
                }
            ...
            case PARAM_RECONFIG_DI_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->hqvCtrl.di.mode = u32Param;
            ...
            case PARAM_RECONFIG_TNR_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->hqvCtrl.tnr.mode = u32Param;
            ...
            case PARAM_RECONFIG_CNR_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->hqvCtrl.cnr.mode = u32Param;
            ...
            case PARAM_RECONFIG_FRC_MODE:
                ...
                if(u32Ret == VPP_OK)
                {
                    pFuncTestCtx->hqvCtrl.frc.mode = u32Param;
