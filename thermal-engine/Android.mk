...
IS_MSMCOBALT:=$(strip $(call is-board-platform,msmcobalt))
IS_MSMFALCON:=$(strip $(call is-board-platform,msmfalcon))
...
ifneq (,$(IS_MSM8996)$(IS_MSM8937))
LOCAL_CFLAGS += -DENABLE_CPU_VOLTAGE_DEV
endif

ifneq (,$(IS_MSM8994)$(IS_MSM8992)$(IS_MSM8996)$(IS_MSMCOBALT)$(IS_MSMFALCON))
...
LOCAL_COPY_HEADERS := ./inc/thermal_client.h
LOCAL_COPY_HEADERS_TO := thermal-engine/inc
