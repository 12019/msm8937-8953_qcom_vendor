    ...
    private class EnrollFaceTask extends AsyncTask<Face, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (id == null || id.isEmpty()) {
                ...
                Face.RecognitionResult recoResult = new Face.RecognitionResult(Face.RecognitionResult.SCORE_THRESHOLD_HIGH, id);
                enrolledFace.recognitionResults = new Face.RecognitionResult[1];
                enrolledFace.recognitionResults[0] = recoResult;
                swapFaceBasedOnCoords(enrolledFace);
                PictureReviewActivity.this.updateUi();
            }
        }
    }
