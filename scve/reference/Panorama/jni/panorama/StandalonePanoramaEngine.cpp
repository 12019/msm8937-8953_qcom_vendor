...
static jboolean JNICALL nInstanceInit(JNIEnv *env, jobject obj, jint width, jint height,
        jint stride, jint colorFormat, jfloat focalLength)
{
        ...
        jint x, jint y)
{
    ...
    keyFrame.rotation = (get_exif_orientation((unsigned char *)jpeg.pData, jpeg.size)) % 360;
