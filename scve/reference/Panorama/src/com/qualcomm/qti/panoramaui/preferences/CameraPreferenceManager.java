...
import com.qualcomm.qti.panoramaui.preferences.camera2.Camera2PreferenceFocusMode;
import com.qualcomm.qti.panoramaui.preferences.camera2.Camera2PreferencePictureSize;
import com.qualcomm.qti.panoramaui.preferences.camera2.Camera2PreferenceSceneMode;
...
import com.qualcomm.qti.panoramaui.preferences.legacycamera.CameraPreferenceFocusMode;
...
import com.qualcomm.qti.panoramaui.preferences.legacycamera.CameraPreferenceSceneMode;
...
public abstract class CameraPreferenceManager {
    ...
    private static void addCommonPreferenceEntries(Context c, PreferenceScreen ps) {
        ...
        debugPrefs.addPreference(createListPreferenceFromResources(c, DEBUG_ENABLE_VERBOSE_LOGGING, 0,
                R.string.debug_settings_enable_loggings,
        ...
        debugPrefs.addPreference(createListPreferenceFromResources(c, DEBUG_SAVE_PREVIEW_FRAMES_KEY, 0,
                R.string.debug_settings_save_preview_frames,
        ...
        debugPrefs.addPreference(createListPreferenceFromResources(c, DEBUG_SAVE_KEY_FRAMES_KEY, 0,
                R.string.debug_settings_save_key_frames,
