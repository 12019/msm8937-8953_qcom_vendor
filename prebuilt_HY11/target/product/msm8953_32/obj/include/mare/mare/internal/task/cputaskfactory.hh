...
private:
  ...
  using kernel = typename ::mare::cpu_kernel<Fn>;
...
template<typename Fn>
struct task_factory_dispatch<::mare::cpu_kernel<Fn>> : public cputask_factory {
...
protected:
  ...
  static bool launch(bool notify, group* g, CpuKernel&& k, Args&& ...args) {
    ...
    if (has_attr(attrs, ::mare::internal::legacy::attr::blocking) == false) {
