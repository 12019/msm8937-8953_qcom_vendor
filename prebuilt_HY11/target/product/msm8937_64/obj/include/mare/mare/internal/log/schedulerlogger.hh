...
#ifndef MARE_USE_SCHEDULER_LOGGER
...
private:
  ...
  MARE_DELETE_METHOD(schedulerlogger());
  MARE_DELETE_METHOD(schedulerlogger(schedulerlogger const&));
  MARE_DELETE_METHOD(schedulerlogger(schedulerlogger&&));
  MARE_DELETE_METHOD(schedulerlogger& operator=(schedulerlogger const&));
  MARE_DELETE_METHOD(schedulerlogger& operator=(schedulerlogger&&));
