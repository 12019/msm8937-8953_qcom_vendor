...
public:
  ...
  MARE_DELETE_METHOD(serial_stage& operator=(serial_stage&& other));

  friend class mare::internal::pipeline_stage_skeleton_base;
...
public:
  ...
  explicit parallel_stage(size_t doc):_degree_of_concurrency(doc) {
    MARE_API_ASSERT(doc > 0, "degree of concurrency should be larger than 0.");
  }
  ...
  MARE_DELETE_METHOD(parallel_stage& operator=(parallel_stage&& other));
...
public:
  ...
  MARE_DELETE_METHOD(iteration_lag& operator=(iteration_lag && other));

  template<typename F, typename... UserData>
  friend class mare::internal::pipeline_cpu_stage_skeleton;

  template<typename BeforeBody, typename GK, typename AfterBody, typename... UserData>
  friend class mare::internal::pipeline_gpu_stage_skeleton;
...
public:
  ...
  MARE_DELETE_METHOD(iteration_rate& operator=(iteration_rate&& other));
...
public:
  ...
  MARE_DELETE_METHOD(sliding_window_size& operator=(sliding_window_size&& other));
  ...
  template<typename... UserData> friend class mare::internal::pipeline_skeleton;
...
public:
  ...
  MARE_DELETE_METHOD(stage_input_base(stage_input_base const& other));
  MARE_DELETE_METHOD(stage_input_base(stage_input_base&& other));
  MARE_DELETE_METHOD(stage_input_base& operator=(stage_input_base const& other));
  MARE_DELETE_METHOD(stage_input_base& operator=(stage_input_base&& other));
...
private:
  ...
  mare::internal::stagebuffer* _buffer;
  ...
  stage_input(mare::internal::stagebuffer* buffer,
              size_t offset,
              size_t input_size,
              size_t first,
...
public:
  ...
  InputType& operator[](size_t i) {
    MARE_API_THROW_CUSTOM(i < _size,
                          std::out_of_range,
                          "Out of range access to stage_input.");
    if(_launch_type == mare::internal::with_sliding_window)  {
       auto bptr = static_cast<mare::internal::ringbuffer<input_type>*>(_buffer);
       size_t id = bptr->get_buffer_index(i + _offset);
       return (*bptr)[id];
     } else {
       auto bptr = static_cast<mare::internal::dynamicbuffer<input_type>*>(_buffer);
       size_t id = bptr->get_buffer_index(i + _offset);
       return (*bptr)[id];
     }
  }
  ...
  MARE_DELETE_METHOD(stage_input(stage_input const& other));
  MARE_DELETE_METHOD(stage_input(stage_input&& other));
  MARE_DELETE_METHOD(stage_input& operator=(stage_input const& other));
  MARE_DELETE_METHOD(stage_input& operator=(stage_input&& other));

  template <typename F, size_t Arity, typename RT>
  friend class mare::internal::cpu_stage_function_arity_dispatch;
  template <typename F, size_t Arity, typename RT>
  friend class mare::internal::gpu_stage_function_arity_dispatch;
...
protected:
  ...
  mare::internal::pipeline_stage_instance*  _stage;

  mare::internal::pipeline_instance_base*   _pipeline_instance;

  pipeline_context_base(size_t iter_id,
                        size_t max_stage_iter,
                        mare::internal::pipeline_stage_instance* stage,
                        mare::internal::pipeline_instance_base* instance):
      _iter_id(iter_id),
...
public:
  ...
  MARE_DELETE_METHOD(pipeline_context_base(pipeline_context_base const& other));
  MARE_DELETE_METHOD(pipeline_context_base(pipeline_context_base&& other));
  MARE_DELETE_METHOD(pipeline_context_base& operator=(pipeline_context_base const& other));
  MARE_DELETE_METHOD(pipeline_context_base& operator=(pipeline_context_base&& other));
};
...
private:
  ...
  pipeline_context(size_t iter_id,
                   size_t max_stage_iter,
                   mare::internal::pipeline_stage_instance* stage,
                   mare::internal::pipeline_instance_base* inst):
...
public:
  ...
  MARE_DELETE_METHOD(pipeline_context(pipeline_context const& other));
  MARE_DELETE_METHOD(pipeline_context(pipeline_context &&other));
  MARE_DELETE_METHOD(pipeline_context& operator=(pipeline_context const& other));
  MARE_DELETE_METHOD(pipeline_context& operator=(pipeline_context&& other));
...
public:
  ...
  UserData* get_data() const {
    return static_cast<mare::internal::pipeline_instance<UserData>*>(
