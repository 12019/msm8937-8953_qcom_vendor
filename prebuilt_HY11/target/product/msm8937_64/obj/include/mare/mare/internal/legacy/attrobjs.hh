...
MARE_CONSTEXPR bool
operator== (mare::internal::legacy::task_attrs const& a, mare::internal::legacy::task_attrs const& b);
MARE_CONSTEXPR bool
operator!= (mare::internal::legacy::task_attrs const& a, mare::internal::legacy::task_attrs const& b);
...
#ifndef _MSC_VER
  friend constexpr bool ::mare::internal::legacy::operator== (task_attrs const& a,
                                                              task_attrs const& b);
  friend constexpr bool ::mare::internal::legacy::operator!= (task_attrs const& a,
                                                              task_attrs const& b);
#endif
...
private:
  ...
  MARE_CONSTEXPR explicit task_attrs(std::int32_t mask):_mask(mask){}
...
private:
  ...
  friend ::mare::internal::legacy::body_with_attrs<Body>
  with_attrs_cpu<>(::mare::internal::legacy::task_attrs const& attrs, Body&& body);
  friend ::mare::internal::legacy::body_with_attrs<Body>
  with_attrs_cpu<>(::mare::internal::legacy::task_attrs const& attrs, Body&& body,
                   std::nullptr_t);
...
#ifndef _MSC_VER
  friend ::mare::internal::legacy::body_with_attrs_gpu<Body, KernelPtr, Kargs...>
  with_attrs_gpu_internal<>(::mare::internal::legacy::task_attrs const& attrs, Body&& body,
                        KernelPtr kernel, Kargs... args);

  friend ::mare::internal::legacy::body_with_attrs_gpu<CpuKernelType,
                                     KernelPtr, Kargs...>
  with_attrs_gpu<>(::mare::internal::legacy::task_attrs const& attrs,
               KernelPtr kernel, Kargs... args);
...
bool operator== (mare::internal::legacy::task_attrs const& a,
                 mare::internal::legacy::task_attrs const& b) {
