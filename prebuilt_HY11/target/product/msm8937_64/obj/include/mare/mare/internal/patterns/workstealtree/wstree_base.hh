...
protected:
  ...
  MARE_DELETE_METHOD(ws_node_base(ws_node_base const&));
  MARE_DELETE_METHOD(ws_node_base(ws_node_base&&));
  MARE_DELETE_METHOD(ws_node_base& operator=(ws_node_base const&));
  MARE_DELETE_METHOD(ws_node_base& operator=(ws_node_base&&));
...
public:
  ...
  size_type count_traversal() const {
    return _traversal.load(mare::mem_order_relaxed);
  }
  void increase_traversal(size_type n,
                          mare::mem_order order = mare::mem_order_seq_cst)
  {
  ...
  bool is_unclaimed(mare::mem_order order = mare::mem_order_seq_cst) {
  ...
  size_type get_progress(mare::mem_order order = mare::mem_order_seq_cst) {
    return _progress.load(order);
  }

  size_type inc_progress(size_type n, mare::mem_order order) {
...
protected:
  ...
  MARE_DELETE_METHOD(ws_tree_base(ws_tree_base const&));
  MARE_DELETE_METHOD(ws_tree_base(ws_tree_base&&));
  MARE_DELETE_METHOD(ws_tree_base& operator=(ws_tree_base const&));
  MARE_DELETE_METHOD(ws_tree_base& operator=(ws_tree_base&&));
};
