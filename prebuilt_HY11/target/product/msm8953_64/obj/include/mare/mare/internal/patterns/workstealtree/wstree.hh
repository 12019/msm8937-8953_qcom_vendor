...
#include <mare/internal/patterns/workstealtree/wstnodepool.hh>
#include <mare/internal/patterns/workstealtree/wstree_base.hh>
...
public:
  ...
  node_type* get_left(mare::mem_order order = mare::mem_order_seq_cst) const
  { return _left.load(order); }
  node_type* get_right(mare::mem_order order = mare::mem_order_seq_cst) const
  ...
  T& peek_value() { return _value; }
  void set_value(T val) { _value = std::move(val); }

  bool is_leaf() { return get_left(mare::mem_order_relaxed) == nullptr; }
...
#include <mare/internal/patterns/workstealtree/wstree_impl.hh>
