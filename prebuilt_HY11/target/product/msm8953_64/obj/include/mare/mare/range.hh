...
#include <mare/internal/util/range.hh>
...
public:
  ...
  size_t num_elems(size_t i) const;
};
...
public:
  ...
  size_t index_to_linear(const mare::index<1>& it) const;

  mare::index<1> linear_to_index(size_t idx) const;
};
...
public:
  ...
  size_t index_to_linear(const mare::index<2>& it) const;

  mare::index<2> linear_to_index(size_t idx) const;
...
public:
  ...
  size_t index_to_linear(const mare::index<3>& it) const;

  mare::index<3> linear_to_index(size_t idx) const;
};
#endif
