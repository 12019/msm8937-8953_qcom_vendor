 ...
 *
 * COPYRIGHT 2011-2013, 2015 Qualcomm Technologies, Inc.
 * All rights reserved.
...
#define OMX_QUALCOMM_INDEX_PARAM_LOOKAHEAD_WINDOW_INFO                    "OMX.Qualcomm.index.param.streaming.LookAheadWindowInfo"
...
/**
* Structure to send info related to look-ahead window mode
*/
typedef struct QOMX_DASH_LOOKAHEAD_WINDOW_INFO
{
  OMX_BOOL bSampleDisc;
  OMX_BOOL bWindowResize;
  OMX_BOOL bWindowEnabled;
}QOMX_DASH_LOOKAHEAD_WINDOW_INFO;
