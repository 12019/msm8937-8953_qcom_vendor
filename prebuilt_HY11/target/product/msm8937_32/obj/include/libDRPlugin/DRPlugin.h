...
typedef void (* reportDrNMEACb_T)(GpsUtcTime  timestamp,
...
public:
    ...
    bool deleteAidingData(const GpsAidingData aidingData);
    bool reportDrPositionCb(GpsLocation & locReport,GpsLocationExtended & locExtendedReport);
