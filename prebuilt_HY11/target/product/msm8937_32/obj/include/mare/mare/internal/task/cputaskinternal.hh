...
public:
  ...
  MARE_DELETE_METHOD(user_code_container_base(user_code_container_base const&));
  MARE_DELETE_METHOD(user_code_container_base(user_code_container_base&&));
  MARE_DELETE_METHOD(user_code_container_base& operator=(user_code_container_base const&));
  MARE_DELETE_METHOD(user_code_container_base& operator=(user_code_container_base&&));
};
...
public:
  ...
  MARE_DELETE_METHOD(user_code_container(user_code_container const&));
  MARE_DELETE_METHOD(user_code_container(user_code_container&&));
  MARE_DELETE_METHOD(user_code_container& operator=(user_code_container const&));
  MARE_DELETE_METHOD(user_code_container& operator=(user_code_container&&));
};
...
public:
  ...
  explicit set_arg_tracker(size_type arity) :
    _args( (1 << arity) - 1 ) {
    MARE_INTERNAL_ASSERT(arity >= min_arity::value,
                         "Arity should be greated than %d.",
                         static_cast<int>(min_arity::value));

    MARE_INTERNAL_ASSERT(arity <= max_arity::value,
  ...
  std::tuple<bool, bool> set(size_type pos) {
    ...
    MARE_INTERNAL_ASSERT(pos <= max_arity::value, "Out of range pos: %d", pos);

    const mask_type mask = ~(1 << (pos));

    mask_type desired;
    mask_type expected = _args.load(mare::mem_order_relaxed);
  ...
  bool are_all_set() {
    return _args.load(mare::mem_order_acquire) == 0;
  }
...
struct arg_container {
  ...
  MARE_DELETE_METHOD(arg_container(arg_container const& other_arg));
  MARE_DELETE_METHOD(arg_container(arg_container&& other_arg));
  MARE_DELETE_METHOD(arg_container& operator=(arg_container const&));
  MARE_DELETE_METHOD(arg_container& operator=(arg_container&&));
...
private:
  ...
  MARE_DELETE_METHOD(arg_container(type const&));
  MARE_DELETE_METHOD(arg_container(arg_container const& other_arg));
  MARE_DELETE_METHOD(arg_container(arg_container&& other_arg));
  MARE_DELETE_METHOD(arg_container& operator=(arg_container const&));
  MARE_DELETE_METHOD(arg_container& operator=(arg_container&&));
...
struct retval_container {
  ...
  MARE_DELETE_METHOD(retval_container(retval_container const& other_arg));
  MARE_DELETE_METHOD(retval_container(retval_container&& other_arg));
  MARE_DELETE_METHOD(retval_container& operator=(retval_container const&));
  MARE_DELETE_METHOD(retval_container& operator=(retval_container&&));
...
struct task_arg_type_info {
  ...
  static_assert(is_lvalue_ref::value == false,
                "This version of MARE does not support lvalue references as task arguments. "
                "Please check the MARE manual.");
...
template <typename T>
struct is_mare_task20_ptr {
  using type = T;
  static MARE_CONSTEXPR_CONST bool value = false;
  static MARE_CONSTEXPR_CONST bool has_return_value = false;
  static MARE_CONSTEXPR_CONST bool has_arguments = false;
};

template <typename T>
struct is_mare_task20_ptr<::mare::task_ptr<T>> {
  using type = T;
  static MARE_CONSTEXPR_CONST bool value = true;
  static MARE_CONSTEXPR_CONST bool has_return_value = true;
  static MARE_CONSTEXPR_CONST bool has_arguments = false;
};

template <>
struct is_mare_task20_ptr<::mare::task_ptr<>> {
  using type = void;
  static MARE_CONSTEXPR_CONST bool value = true;
  static MARE_CONSTEXPR_CONST bool has_return_value = false;
  static MARE_CONSTEXPR_CONST bool has_arguments = false;
...
struct is_mare_task20_ptr<::mare::task_ptr<R(Args...)>> {
  using type = R;
  static MARE_CONSTEXPR_CONST bool value = true;
  static MARE_CONSTEXPR_CONST bool has_return_value = true;
  static MARE_CONSTEXPR_CONST bool has_arguments = true;
};

template <typename T>
struct is_mare_task20_ptr<::mare::task<T>*> {
  using type = T;
  static MARE_CONSTEXPR_CONST bool value = true;
  static MARE_CONSTEXPR_CONST bool has_return_value = true;
  static MARE_CONSTEXPR_CONST bool has_arguments = false;
...
template <>
struct is_mare_task20_ptr<::mare::task<>*> {
  using type = void;
  static MARE_CONSTEXPR_CONST bool value = true;
  static MARE_CONSTEXPR_CONST bool has_return_value = false;
  static MARE_CONSTEXPR_CONST bool has_arguments = false;
...
template <typename R, typename... Args>
struct is_mare_task20_ptr<::mare::task<R(Args...)>*> {
  using type = R;
  static MARE_CONSTEXPR_CONST bool value = true;
  static MARE_CONSTEXPR_CONST bool has_return_value = true;
  static MARE_CONSTEXPR_CONST bool has_arguments = true;
...
struct task_type_info {
  ...
  using collapse_actual =
      ...
      CollapseRequested &&
      is_mare_task20_ptr<typename user_code_traits::return_type>::value>;

  using collapsed_return_type =
      typename std::conditional<collapse_actual::value,
      typename is_mare_task20_ptr<typename user_code_traits::return_type>::type,
  ...
  static_assert(std::is_reference<typename user_code_traits::return_type>::value == false,
                "This version of MARE does not support references as the return type of tasks."
                "Please check the MARE manual.");
...
public:
  using helper                = typename ::mare::internal::is_by_value_helper_t<no_ref>;
  static MARE_CONSTEXPR_CONST bool value = helper::value;
...
public:
  using helper                = typename ::mare::internal::is_by_data_dep_helper_t<no_ref>;
  static MARE_CONSTEXPR_CONST bool value = helper::value;
  using type                  = typename std::conditional<value,
                                                          typename helper::type,
                                                          T>::type;
...
public:
  ...
  static MARE_CONSTEXPR_CONST bool value = type::value;
...
private:
  ...
  using return_type       = typename ::mare::internal::is_mare_task20_ptr<pred_type_nocvref>::type;

public:
  static MARE_CONSTEXPR_CONST bool value =
...
static ::mare::internal::task* get_cptr(ArgType* arg) {
  using decayed_argtype = typename std::decay<ArgType*>::type;
  static_assert(is_mare_task20_ptr<decayed_argtype>::value, "");

  return ::mare::internal::c_ptr(static_cast<::mare::task<>*>(arg));
}
...
static ::mare::internal::task* get_cptr(ArgType&& arg) {
  ...
  return ::mare::internal::c_ptr(arg);
}
