...
public:
  ...
  bool operator<(buffer_iterator const& it) const {
    MARE_INTERNAL_ASSERT(it._p_buffer_ptr != nullptr,
                         "buffer_iterator set to a null buffer");
    MARE_INTERNAL_ASSERT(_p_buffer_ptr == it._p_buffer_ptr,
  ...
  MARE_DEFAULT_METHOD(buffer_iterator(buffer_iterator const&));
  MARE_DEFAULT_METHOD(buffer_iterator& operator=(buffer_iterator const&));
  MARE_DEFAULT_METHOD(buffer_iterator(buffer_iterator&&));
  MARE_DEFAULT_METHOD(buffer_iterator& operator=(buffer_iterator&&));
};
...
public:
  ...
  MARE_DEFAULT_METHOD(buffer_const_iterator(buffer_const_iterator const&));
  MARE_DEFAULT_METHOD(buffer_const_iterator& operator=(buffer_const_iterator const&));
  MARE_DEFAULT_METHOD(buffer_const_iterator(buffer_const_iterator&&));
  MARE_DEFAULT_METHOD(buffer_const_iterator& operator=(buffer_const_iterator&&));
};
