...
void gpu_custom_launch_local_size(const mare::range<DIMS>& r, const mare::range<DIMS>& lr, BWAG bwag)
{
  ...
  gpu_kernel_dispatch::
    ...
    MARE_ALOG("cl::CommandQueue::enqueueNDRangeKernel() time = %0.6f us",
