  ...
  public:
    ...
    inline bool allocate(size_t& id, size_t pool_count) {
      while (true) {
        ...
        size_t bit_index = mare_ffs(~current_bitmap);
...
private:
  ...
  MARE_DELETE_METHOD(pipeline_slab_allocator(pipeline_slab_allocator const&));
  MARE_DELETE_METHOD(pipeline_slab_allocator& operator=(pipeline_slab_allocator const&));
  MARE_DELETE_METHOD(pipeline_slab_allocator(pipeline_slab_allocator const&&));
  MARE_DELETE_METHOD(pipeline_slab_allocator& operator=(pipeline_slab_allocator const&&));
};
