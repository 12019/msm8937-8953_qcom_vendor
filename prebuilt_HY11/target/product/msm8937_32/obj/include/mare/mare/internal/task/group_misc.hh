...
#include <mare/internal/util/concurrent_dense_bitmap.hh>
...
class lattice_node
{
  ...
  friend class ::mare::internal::meet;
...
protected:
  ...
  MARE_DELETE_METHOD(lattice_node(lattice_node const&));
  MARE_DELETE_METHOD(lattice_node(lattice_node&&));
  MARE_DELETE_METHOD(lattice_node& operator=(lattice_node const&));
  MARE_DELETE_METHOD(lattice_node& operator=(lattice_node&&));
