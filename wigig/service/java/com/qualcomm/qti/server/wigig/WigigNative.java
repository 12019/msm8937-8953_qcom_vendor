...
public class WigigNative {
    ...
    static {
        /* Native functions are defined in libwigig-service.so */
    ...
    private native boolean setSoftApNative(String ifname, String ssid, boolean hidden, int channel,
                                           boolean secured, String key);
    ...
    public String waitForEvent() {
        // No synchronization necessary .. it is implemented in WigigMonitor
    ...
    public boolean startWpsPinKeypad(String iface, String pin) {
        ...
        synchronized (mLock) {
            // note, wifi implementation has a bug. "WPS_PIN any <pin>" returns
            // the same pin, not "OK".
            String result = doStringCommandNative("IFNAME=" + iface + " WPS_PIN any " + pin);
            return !TextUtils.isEmpty(result);
        }
    }
    ...
    public boolean setSoftAp(String ifname, String ssid, boolean hidden, int channel,
                             boolean secured, String key) {
        return setSoftApNative(ifname, ssid, hidden, channel, secured, key);
    }
}
