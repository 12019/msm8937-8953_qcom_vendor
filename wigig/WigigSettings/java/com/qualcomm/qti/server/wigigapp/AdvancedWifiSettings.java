...
public class AdvancedWifiSettings extends WigigActivity {
    ...
    private void initPreferences() {
        ...
        mWpsLabelPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            public boolean onPreferenceClick(Preference arg0) {
                WpsFragment wpsFragment = new WpsFragment(WpsInfo.LABEL);
    ...
    public class WpsFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            if (mWpsDialog == null || !mWpsDialog.isShowing())
                mWpsDialog = new WpsDialog(getActivity(), mWpsSetup, mWigigManager);
