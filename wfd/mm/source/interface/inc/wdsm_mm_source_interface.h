...
WFD_status_t wfd_mm_get_negotiated_capability_source(WFD_MM_HANDLE hHandle,
                                WFD_MM_capability_t* pMMCfg_local,      WFD_MM_Extended_capability_t* pMMCfg_local_ex,
                                WFD_MM_capability_t* pMMCfg_remote,     WFD_MM_Extended_capability_t* pMMCfg_remote_ex,
                                WFD_MM_capability_t* pMMCfg_negotiated, WFD_MM_Extended_capability_t* pMMCfg_negotiated_ex,
                                WFD_MM_capability_t* pMMCfg_common,     WFD_MM_Extended_capability_t* pMMCfg_common_ex);
...
WFD_status_t wfd_mm_update_session_source(WFD_MM_HANDLE, WFD_MM_capability_t *, wfd_mm_update_session_cb,WFD_MM_Extended_capability_t *);

/* create/destroy */
WFD_status_t wfd_mm_create_session_source(WFD_MM_HANDLE *hHandle, WFD_device_t tDevice, WFD_MM_capability_t *pNegCap,
                                          WFD_MM_Aux_capability_t *pAuxCap, WFD_MM_Extended_capability_t *pNegCapEx,WFD_MM_callbacks_t* pCallback);
...
void wfd_mm_streaming_query_response_source(WFD_MM_HANDLE handle, bool bStreamingStatus);
#ifdef __cplusplus
}
#endif
