...
libmm-wfd-def += -USYSTRACE_PROFILE
# ---------------------------------------------------------------------------------
#            MM-FRAMEWORK INC
# ---------------------------------------------------------------------------------
...
mm-wfd-inc += $(TOP)/external/libpng/
...
mm-wfd-inc += $(TOP)/frameworks/native/include/ui
...
mm-wfd-inc += $(TARGET_OUT_HEADERS)/mm-rtp/encoder/include
mm-wfd-inc += $(TOP)/external/tinyalsa/include
...
mm-wfd-inc += $(LOCAL_PATH)/../../wfdmmservice/inc
...
LOCAL_CFLAGS += -DPLATFORM_MSM_COBALT
endif
...
LOCAL_SRC_FILES += src/WFDMMSourceOverlaySource.cpp
...
LOCAL_SRC_FILES += src/WFDMMSourceImageEncode.cpp
LOCAL_SRC_FILES += src/WFDMMSourcePngEncode.cpp
