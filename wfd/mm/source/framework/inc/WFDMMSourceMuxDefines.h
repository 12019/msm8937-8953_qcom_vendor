...
typedef enum {
   MUX_OVERLAY_NONE,             /* flag indicating no Overlay */
   MUX_OVERLAY_VENDOR_SPECIFIC,  /* Overlay Vendor Specific    */
} MUX_overlay_type;
...
struct MuxerConfigType
{
   ...
   MUX_overlay_subtype   sOverlayParams;
