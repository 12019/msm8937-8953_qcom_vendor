...
/*------------------------------------------------------------------------------
     A structure for storing custom information in an OMXBUFFERHEADER
--------------------------------------------------------------------------------
*/
...
public:
    ...
    WFDMMSourceVideoEncode(WFDMMSourceStatistics*);
...
private:
    ...
    OMX_ERRORTYPE configureCodecParam(
        VideoEncStaticConfigType* pConfig);
