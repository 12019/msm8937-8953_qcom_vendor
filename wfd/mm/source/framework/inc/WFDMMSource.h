...
#ifndef OVERLAY_CAPTURE
#define OVERLAY_CAPTURE
#endif
...
class WFDMMSourceOverlaySource; //forward declaration
#endif
class AudioSource;
class Muxer;
...
public:
    ...
    void UpdateStreamingQueryResponse(bool bStreamingStatus);
...
private:
    ...
    int           isVideoCodecValidEx(WFD_MM_Extended_capability_t* pNegotiatedCapEx);
    ...
    static void OverlayDeliveryFn(OMX_BUFFERHEADERTYPE* pBuffer, void *);
    ...
    OMX_ERRORTYPE ExtractOverlayParameters();
    OMX_ERRORTYPE FillSinkParameters();
    void getResolutionRefreshRate(uint32, uint64, uint32 );
    void getAuxResolutionFromBitmap(uint8 cea_mode);
    ...
    OMX_ERRORTYPE updateMuxVideoParams(bool bStreamingActive);
    ...
    OMX_ERRORTYPE EnableStreamingResources();
    OMX_ERRORTYPE DisableStreamingResources();

    VideoSource*  m_pVideoSource;

#ifdef OVERLAY_CAPTURE
    WFDMMSourceOverlaySource* m_pOverlaySource;
    OverlaySrcConfigType*     m_pOverlayConfig;
#endif

    WFDMMTouchEventObserver* m_pTEO;
    Muxer* m_pSink;
    ...
    WFD_MM_Extended_capability_t *m_pNegotiatedCapEx;
    WFD_MM_Aux_capability_t *m_pAuxCap;
    ...
    MM_HANDLE m_WFDMMSourceStartStreamingSignal;
    MM_HANDLE m_WFDMMSourceStopStreamingSignal;
    ...
    static const uint32 WFD_MM_SOURCE_STREAMING_START;
    static const uint32 WFD_MM_SOURCE_STREAMING_STOP;
