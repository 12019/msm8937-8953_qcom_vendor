...
public:
    ...
    OMX_ERRORTYPE  CollectOutputBuffer();
...
private:
    ...
    static void ReceiveMessage(void* handle, WFDMessage *pMsg);
    ...
    bool GetOutputPortDefinition();
    bool CompletePortReconfiguration();
    ...
    uint32 mPortReconfigInProgress;
    WFDMessageService *mpMsgService;
