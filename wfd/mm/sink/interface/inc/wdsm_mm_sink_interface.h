...
WFD_status_t wfd_mm_get_local_capability_sink(WFD_MM_HANDLE hHandle, WFD_MM_capability_t* pMMCfg,
                                              int* nAVFormatCount, WFD_MM_Extended_capability_t** pMMExtCfg,
                                              WFD_MM_Aux_capability_t**,WFD_device_t);
...
/* create/destroy */
WFD_status_t wfd_mm_create_session_sink(WFD_MM_HANDLE *hHandle,
