...
wfdmmsource_item* wfdmmsourcequeue::Push(void * buffer)
{
  ...
  MM_MSG_PRIO2(MM_GENERAL, MM_PRIO_MEDIUM, "wfdmmsourcequeue::Push before write Queue size is %d  write index is %i",m_nSize, m_nWrite);
  ...
  MM_MSG_PRIO2(MM_GENERAL, MM_PRIO_MEDIUM, "wfdmmsourcequeue::Push after write Queue size is %d  write index is %i",m_nSize, m_nWrite);
