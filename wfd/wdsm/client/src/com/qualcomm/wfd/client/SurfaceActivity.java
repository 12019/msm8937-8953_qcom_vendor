...
public class SurfaceActivity extends Activity{
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        enableDisableDSMenuItem = menu.findItem(R.id.menu_enable_disable_DS);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case PAUSE_CALLBACK: {
                    ...
                    /* This situation can happen in DS scenario where due to
                       STANDBY , it moves to Mirroring and that will trigger a port change and on port change
                       there will be a PAUSE_CALLBACK. If this check is not present then
                       it will set title to STANDBY for button.
                       This will not happen in normal scenario as PAUSE is not allowed in STANDBY*/
                    if(!modeStandby){
                        standbyResumeMenuItem.setTitle("Standby");
                    }
