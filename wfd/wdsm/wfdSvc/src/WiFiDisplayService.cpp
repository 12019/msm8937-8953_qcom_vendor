...
int WiFiDisplayService::setVideoSurfaceProp(int width,int height,int orientation)
{
    setSurfaceProp(width,height,orientation);
    return 0;
}
...
int WiFiDisplayService::getUIBCCategory()
{
    return getUIBCSupportCategory();
}
