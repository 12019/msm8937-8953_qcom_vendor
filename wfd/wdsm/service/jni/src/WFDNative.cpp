...
static int getWFDFormatKeyCode(int androidKeyCode, int metaState)
{
   ...
   LOGD("getWFDFormatKeyCode: Android code %d,wfd code %d", androidKeyCode, wfdKeyCode);
   return wfdKeyCode;
}
...
{
    LOGD("%lf resAspectRatio screenAspectRatio %lf original xin = %lf yin = %lf",
    ...
    case WFD_UIBC_TOUCH:
     {
        ...
        if(uibcParam->multiMode) {
            if(uibcParam->prevEv->getPointerCount() < ev->parms.touch_event.num_pointers) {
                ...
                if(pointerID.size() != 1 ) {
                   LOGD("Abrupt change in pointer co-ords, Multi touch mode is OFF");
...
static void getWFDHIDEvent(KeyEvent *ke, WFD_uibc_event_t *ev)
{
    if(ke == NULL || ev == NULL)
    {
        LOGE("Key event pointer or UIBC pointer NULL");
        return;
    }
    int keycode = -1;
    int inputKeyCode = ke->getKeyCode();
    if (inputKeyCode >= AKEYCODE_1 && inputKeyCode <= AKEYCODE_9)
    {
        keycode = 0x1e;
        keycode += (inputKeyCode - AKEYCODE_1);
    }
    else if (inputKeyCode >= AKEYCODE_A && inputKeyCode <= AKEYCODE_Z)
    {
        keycode = 0x04;
        keycode += (inputKeyCode - AKEYCODE_A);
    }
    else if (inputKeyCode >= AKEYCODE_F1 && inputKeyCode <= AKEYCODE_F12)
    {
        keycode = 0x3a;
        keycode += (inputKeyCode - AKEYCODE_F1);
    }
    else if (inputKeyCode >= AKEYCODE_NUMPAD_1 && inputKeyCode <= AKEYCODE_NUMPAD_9)
    {
        keycode = 0x59;
        keycode += (inputKeyCode - AKEYCODE_NUMPAD_1);
    }
    else
    {
        switch (ke->getKeyCode())
        {
            case AKEYCODE_ESCAPE             :    keycode = 0x29;break;
            case AKEYCODE_0                  :    keycode = 0x27;break;
            case AKEYCODE_MINUS              :    keycode = 0x2d;break;
            case AKEYCODE_EQUALS             :    keycode = 0x2e;break;
            case AKEYCODE_DEL                :    keycode = 0x2a;break;
            case AKEYCODE_TAB                :    keycode = 0x2b;break;
            case AKEYCODE_LEFT_BRACKET       :    keycode = 0x2f;break;
            case AKEYCODE_RIGHT_BRACKET      :    keycode = 0x30;break;
            case AKEYCODE_ENTER              :    keycode = 0x28;break;
            case AKEYCODE_CTRL_LEFT          :    keycode = 0xE0;break;
            case AKEYCODE_SEMICOLON          :    keycode = 0x33;break;
            case AKEYCODE_APOSTROPHE         :    keycode = 0x34;break;
            case AKEYCODE_GRAVE              :    keycode = 0x35;break;
            case AKEYCODE_BACKSLASH          :    keycode = 0x31;break;
            case AKEYCODE_COMMA              :    keycode = 0x36;break;
            case AKEYCODE_PERIOD             :    keycode = 0x37;break;
            case AKEYCODE_SLASH              :    keycode = 0x38;break;
            case AKEYCODE_SPACE              :    keycode = 0x2c;break;
            case AKEYCODE_NUMPAD_MULTIPLY    :    keycode = 0x55;break;
            case AKEYCODE_ALT_LEFT           :    keycode = 0xE2;break;
            case AKEYCODE_CAPS_LOCK          :    keycode = 0x39;break;
            case AKEYCODE_NUM_LOCK           :    keycode = 0x53;break;
            case AKEYCODE_SCROLL_LOCK        :    keycode = 0x47;break;
            case AKEYCODE_NUMPAD_SUBTRACT    :    keycode = 0x56;break;
            case AKEYCODE_NUMPAD_ADD         :    keycode = 0x57;break;
            case AKEYCODE_NUMPAD_0           :    keycode = 0x62;break;
            case AKEYCODE_NUMPAD_DOT         :    keycode = 0x63;break;
            case AKEYCODE_ZENKAKU_HANKAKU    :    keycode = 0x94;break;
            case AKEYCODE_RO                 :    keycode = 0x87;break;
            case AKEYCODE_HENKAN             :    keycode = 0x8a;break;
            case AKEYCODE_KATAKANA_HIRAGANA  :    keycode = 0x88;break;
            case AKEYCODE_MUHENKAN           :    keycode = 0x8b;break;
            case AKEYCODE_NUMPAD_ENTER       :    keycode = 0x58;break;
            case AKEYCODE_CTRL_RIGHT         :    keycode = 0xE4;break;
            case AKEYCODE_NUMPAD_DIVIDE      :    keycode = 0x54;break;
            case AKEYCODE_SYSRQ              :    keycode = 0x9A;break;
            case AKEYCODE_ALT_RIGHT          :    keycode = 0xE6;break;
            case AKEYCODE_MOVE_HOME          :    keycode = 0x4a;break;
            case AKEYCODE_DPAD_UP            :    keycode = 0x52;break;
            case AKEYCODE_PAGE_UP            :    keycode = 0x4b;break;
            case AKEYCODE_DPAD_LEFT          :    keycode = 0x50;break;
            case AKEYCODE_DPAD_RIGHT         :    keycode = 0x4f;break;
            case AKEYCODE_MOVE_END           :    keycode = 0x4d;break;
            case AKEYCODE_DPAD_DOWN          :    keycode = 0x51;break;
            case AKEYCODE_PAGE_DOWN          :    keycode = 0x4e;break;
            case AKEYCODE_INSERT             :    keycode = 0x49;break;
            case AKEYCODE_FORWARD_DEL        :    keycode = 0x4c;break;
            case AKEYCODE_VOLUME_MUTE        :    keycode = 0x7f;break;
            case AKEYCODE_VOLUME_DOWN        :    keycode = 0x81;break;
            case AKEYCODE_VOLUME_UP          :    keycode = 0x80;break;
            case AKEYCODE_POWER              :    keycode = 0x66;break;
            case AKEYCODE_NUMPAD_EQUALS      :    keycode = 0x67;break;
            case AKEYCODE_BREAK              :    keycode = 0x48;break;
            case AKEYCODE_NUMPAD_COMMA       :    keycode = 0x85;break;
            case AKEYCODE_KANA               :    keycode = 0x90;break;
            case AKEYCODE_EISU               :    keycode = 0x91;break;
            case AKEYCODE_YEN                :    keycode = 0x89;break;
            case AKEYCODE_META_LEFT          :    keycode = 0xe3;break;
            case AKEYCODE_META_RIGHT         :    keycode = 0xe7;break;
            case AKEYCODE_MENU               :    keycode = 0x65;break;
            case AKEYCODE_MEDIA_STOP         :    keycode = 0x78;break;
            case AKEYCODE_CALCULATOR         :    keycode = 0xfb;break;
            case AKEYCODE_SLEEP              :    keycode = 0xf8;break;
            case AKEYCODE_WAKEUP             :    keycode = 0xf9;break;
            case AKEYCODE_EXPLORER           :    keycode = 0x8a;break;
            case AKEYCODE_BACK               :    keycode = 0xf1;break;
            case AKEYCODE_FORWARD            :    keycode = 0xf2;break;
            case AKEYCODE_MEDIA_EJECT        :    keycode = 0xec;break;
            case AKEYCODE_MEDIA_NEXT         :    keycode = 0xeb;break;
            case AKEYCODE_MEDIA_PLAY_PAUSE   :    keycode = 0xe8;break;
            case AKEYCODE_MEDIA_PREVIOUS     :    keycode = 0xea;break;
            case AKEYCODE_NUMPAD_LEFT_PAREN  :    keycode = 0xb6;break;
            case AKEYCODE_NUMPAD_RIGHT_PAREN :    keycode = 0xb7;break;
            case AKEYCODE_SHIFT_LEFT         :    keycode = 0xe1;break;
            case AKEYCODE_SHIFT_RIGHT        :    keycode = 0xe5;break;
        }
    }

    if (keycode > 0)
    {
        LOGD("Found HID Key Event, prepare UIBC struct");
        ev->type = WFD_UIBC_HID_KEY;
        ev->parms.key_event.key_code_1 = keycode;
        ev->parms.key_event.key_code_2 = 0;
        //Fill Meta Info
        if (ke->getMetaState() & AMETA_CTRL_LEFT_ON)
            ev->parms.key_event.key_code_2 |= BIT0;
        if (ke->getMetaState() & AMETA_CTRL_RIGHT_ON)
            ev->parms.key_event.key_code_2 |= BIT4;
        if (ke->getMetaState() & AMETA_ALT_LEFT_ON)
            ev->parms.key_event.key_code_2 |= BIT2;
        if (ke->getMetaState() & AMETA_ALT_RIGHT_ON)
            ev->parms.key_event.key_code_2 |= BIT6;
        if (ke->getMetaState() & AMETA_SHIFT_LEFT_ON)
            ev->parms.key_event.key_code_2 |= BIT1;
        if (ke->getMetaState() & AMETA_SHIFT_RIGHT_ON)
            ev->parms.key_event.key_code_2 |= BIT5;

        if (ke->getAction() == AKEY_EVENT_ACTION_DOWN)
        {
            ev->parms.key_event.type = WFD_UIBC_KEY_DOWN;
        }
        else if (ke->getAction() == AKEY_EVENT_ACTION_UP)
        {
            ev->parms.key_event.type = WFD_UIBC_KEY_UP;
        }
    }
    LOGE("Received HID Event %d and converted to %x keycode2=",
         keycode, ke->getKeyCode(), ev->parms.key_event.key_code_2);
}
...
static void  convertToWFDFormat (InputEvent *ie, WFD_uibc_event_t *ev)
{
  ...
  switch (eventtype)
  {
    ...
    case AINPUT_EVENT_TYPE_KEY:
    {
      ...
      // Initializing keycode 2, currently unused for Generic
      // but stores modifier byte for HID
      ev->parms.key_event.key_code_2 = 0;
      // Currently a Hybrid of HID and Generic Format is supported
      // If Alt or Ctrl is pressed, HID key codes shall be used
      // In all other cases, Generic Keycodes are preferred.
      int key_code = -1;
      if (uibcParam->nUibcInfo == 0xFFFF)
      {
          int ret = WiFiDisplayClient::getUIBCSupportCategory();
          LOGD("WiFiDisplayClient::getUIBCSupportCategory() returned %d",ret);
          uibcParam->nUibcInfo = ret;
      }
      if ((uibcParam->nUibcInfo & GENERIC))
      {
          int metaState = ke->getMetaState();
          if (((metaState & AMETA_CTRL_ON) || (metaState & AMETA_ALT_ON)) &&
              (uibcParam->nUibcInfo & HIDC))
          {
              getWFDHIDEvent(ke, ev);
              break;
          }
          // Following is executed for Generic
          key_code = getWFDFormatKeyCode(ke->getKeyCode(),ke->getMetaState());
      }
      if (key_code < 0 && (uibcParam->nUibcInfo & HIDC))
      {
          LOGE("Unsupported Generic, try HID");
          getWFDHIDEvent(ke, ev);
          break;
      }
      ev->parms.key_event.key_code_1 = key_code;
      switch(ke->getAction())
      {
  ...
  (JNIEnv *env, jclass cls, jint mode)
{
    ...
    LOGD("WiFiDisplayClient::setAVPlaybackMode returned = %d",ret);
  ...
  (JNIEnv *env, jclass cls, jobject thisDevice)
{
    ...
    if (dev) {
       ...
       LOGD("Calling WiFiDisplayClient::enableWfd returned %d",bWFDenableflag);
       delete dev;
    }
  ...
  (JNIEnv *env, jclass cls, jobject peerDevice)
{
    ...
    if (dev != NULL) {
        ...
        LOGD("Calling WiFiDisplayClient::startWfdSession returned %d", res);
  ...
  (JNIEnv *env, jclass cls, jint sid)
{
    ...
    LOGD("Calling WiFiDisplayClient::stopWfdSession returned %d", res);
}
  ...
  (JNIEnv *env, jclass cls, jint sid, jboolean secureFlag)
{
    ...
    LOGD("Calling WiFiDisplayClient::play_rtsp returned %d",res);
}
  ...
  (JNIEnv *env, jclass cls, jint sid, jboolean secureFlag)
{
    ...
    LOGD("Calling WiFiDisplayClient::pause_rtsp returned %d",res);
}
  ...
  (JNIEnv *env, jclass cls, jint sid, jboolean isTriggered)
{
    ...
    LOGD("Calling WiFiDisplayClient::teardown_rtsp returned %d",res);
}
...

{
    UNUSED(env);
    UNUSED(cls);
    LOGD("setUIBC with session ID %d ", sessionId);
  ...
  (JNIEnv *env, jclass cls, jobject jobj)
{
    ...
    LOGD("Calling WiFiDisplayClient::startUIBC returned %d",ret);
}
  ...
  (JNIEnv *env, jclass cls)
{
    ...
    LOGD("Calling WiFiDisplayClient::stopUIBC returned %d",ret);
}
  ...
  (JNIEnv *env, jclass cls, jobject javaSurface)
{
    ...
    LOGD("Calling WiFiDisplayClient::setSurface returned %d",ret);
}
/*
 * Class:     com_qualcomm_wfd_WFDNative
  ...
  (JNIEnv *env, jclass cls, jint bitrate)
{
    ...
    LOGD("Calling WiFiDisplayClient:::setBitrate returned %d",res);
}
  ...
  (JNIEnv *env, jclass cls, jint transportType, jint bufferLengthMs, jint port)
{
    ...
    LOGD("Calling WiFiDisplayClient::negotiateRtpTransport returned %d", res);
}
  ...
  (JNIEnv *env, jclass cls, jint transportType)
{
    ...
    LOGD("Calling WiFiDisplayClient::setRtpTransport returned %d", res);
}
  ...
  (JNIEnv *, jclass)
{
    ...
    LOGD("Calling WiFiDisplayClient::queryTCPTransportSupport returned %d", res);
}
  ...
  (JNIEnv *env, jclass cls, jint latency)
{
    ...
    LOGD("Calling WiFiDisplayClient::setDecoderLatency returned %d", res);
}
  ...
  (JNIEnv *env, jclass cls, jint cmdType, jint cmdVal)
{
    ...
    LOGD("Calling WiFiDisplayClient::tcpPlaybackControl returned %d", res);
}
  ...
  (JNIEnv * env, jclass cls, jint cmd)
{
    ...
    LOGD("Calling WiFiDisplayClient::executeRuntimeCommand returned %d", ret);
    if(ret == 0)
      return JNI_FALSE;
    else
      return JNI_TRUE;
