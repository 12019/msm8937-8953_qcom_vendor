...
static const char serverPort[] = "server_port";
...
public:
    setParamCommand(rtspCmdType type, rtspSession &state) : rtspCommands(setParameterCmd, type, state) {dsSupport = true;}
    setParamCommand(rtspCmdType type, rtspCmds cmd, rtspSession &state) : rtspCommands(setParameterCmd, type, cmd, state) {dsSupport = true;}
    setParamCommand(rtspCmdType type, bitset<WFD_MAX_SIZE> params, rtspSession &state) : rtspCommands(setParameterCmd, type, params, state) {dsSupport = true;}
    string send();
