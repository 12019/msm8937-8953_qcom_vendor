...
private:
    ...
    static bool mbDirectStreamingReq;
...
public:
    ...
    static bool streamPlay(bool bsync = false);
    static bool streamPlayPrepare();
    static bool streamPause(bool bsync = false);

    static bool standby();
    static bool resume();

    static bool updateSession(MMCapability*, bool bResetCodec = false);

    static bool sendIDRFrame();
    static bool setFrameRate(int);
    static bool setBitRate(int);
    static bool setSurfaceProp(int width,int height,int orientation);
    ...
    static void StreamingQueryResponse(bool bStreamingStatus);
