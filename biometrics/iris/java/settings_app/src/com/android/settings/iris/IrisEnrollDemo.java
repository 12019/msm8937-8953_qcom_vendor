 ...
 */
public class IrisEnrollDemo extends IrisEnrollBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.iris_enroll_demo);
        setHeaderText(R.string.security_settings_iris_enroll_demo_title);
        if (mToken == null) {
            launchConfirmLock();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CONFIRM_REQUEST) {
            ...
            if (resultCode == RESULT_FINISHED) {
                ...
                int enrolled = irisManager.getEnrolledIris().size();
