...
static void imx258_gt24c32_format_dcdata(sensor_eeprom_data_t *e_ctrl)
{
  ...
  e_ctrl->eeprom_data.dualc.system_calib_params.ref_mono_gain
    = (unsigned short)(buffer[AE_SYNC+2] | (buffer[AE_SYNC+3] << 8));
  e_ctrl->eeprom_data.dualc.system_calib_params.ref_mono_linecount
    = (unsigned short)(buffer[AE_SYNC+4] | (buffer[AE_SYNC+5] << 8));
  e_ctrl->eeprom_data.dualc.system_calib_params.ref_bayer_gain
    = (unsigned short)(buffer[AE_SYNC+6] | (buffer[AE_SYNC+7] << 8));
  e_ctrl->eeprom_data.dualc.system_calib_params.ref_bayer_linecount
    = (unsigned short)(buffer[AE_SYNC+8] | (buffer[AE_SYNC+9] << 8));
  e_ctrl->eeprom_data.dualc.system_calib_params.ref_bayer_color_temperature
