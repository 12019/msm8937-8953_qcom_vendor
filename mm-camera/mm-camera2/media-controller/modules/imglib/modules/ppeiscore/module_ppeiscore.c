...
/**
 * Function: ppeiscore_get_color_format
 *
 ...
 * Notes: none
 **/
int ppeiscore_get_color_format(cam_format_t cam_fmt)
{
  int color_fmt = 0;
  ...
  imgbase_stream_t *stream, isp_dis_config_info_t *dis_config)
{
  ...
  color_fmt = ppeiscore_get_color_format(stream->stream_info->fmt);
