 ...
 *   @co_funcs     : DT function pointer
 *   @co_funcs     : PT function pointer
 *   @co_funcs     : CT function pointer
 *   @co_funcs     : SM function pointer
 *   @co_funcs     : GB function pointer
 *   @co_funcs     : FR function pointer
 *
 *   SW library handle.
 **/
typedef struct {
