...
static const mct_event_module_type_t
...
/** isp_sub_module_port_set_led_calibration
 *
 *  @module: mct module handle
 *  @isp_sub_module: isp sub module handle
 *  @event: event handle
 ...
 *  Return TRUE on success and FALSE on failure
 **/
boolean isp_sub_module_port_set_led_calibration(mct_module_t *module,
  isp_sub_module_t *isp_sub_module, mct_event_t *event)
{
  mct_event_control_parm_t      *set_param = NULL;
  cam_led_calibration_mode_t    *p_calibration_mode = NULL;
  ...
  RETURN_IF_NULL(set_param);

  p_calibration_mode = (cam_led_calibration_mode_t *)set_param->parm_data;
  RETURN_IF_NULL(p_calibration_mode);

  isp_sub_module->led_calibration_mode = *p_calibration_mode;
